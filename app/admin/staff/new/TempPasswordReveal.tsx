...
export default function TempPasswordReveal({ email, tempPassword }: { email: string; tempPassword: string }) {
  ...
  return (
    <div style={{ border: "1px solid #ccc", borderRadius: 6, padding: 16 }}>
      <p style={{ fontWeight: "bold", marginBottom: 12 }}>Account created.</p>
      <p style={{ fontSize: 13, color: "#b00", marginBottom: 12 }}>
        This password is shown once and can't be retrieved again -- copy it now and send it to them.
      </p>
